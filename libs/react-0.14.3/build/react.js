    ...
    if (RESERVED_SPEC_KEYS.hasOwnProperty(name)) {
      ...
      if (shouldAutoBind) {
        ...
        if (isAlreadyDefined) {
          ...
          !(isReactClassMethod && (specPolicy === SpecPolicy.DEFINE_MANY_MERGED || specPolicy === SpecPolicy.DEFINE_MANY)) ? "development" !== 'production' ? invariant(false, 'ReactClass: Unexpected spec policy %s for key %s ' + 'when mixing in component __tests__.', specPolicy, name) : invariant(false) : undefined;
...
/**
 * @see http://www.whatwg.org/__tests__/web-apps/current-work/multipage/the-input-element.html#input-type-attr-summary
 */
